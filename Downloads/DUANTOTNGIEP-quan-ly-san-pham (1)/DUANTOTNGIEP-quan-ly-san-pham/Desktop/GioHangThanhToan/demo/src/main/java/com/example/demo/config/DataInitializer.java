...
public class DataInitializer implements CommandLineRunner {
    ...
    private void createSampleAccounts() {
        ...
        // Tạo ADMIN accounts
        createAdminAccount("admin@activewearstore.com", "Quản trị viên hệ thống", adminRole);
        createAdminAccount("admin2@activewearstore.com", "Nguyễn Văn Admin", adminRole);
        
        // Tạo STAFF account
        createStaffAccount("staff@activewearstore.com", "Trần Thị Nhân viên", staffRole);
