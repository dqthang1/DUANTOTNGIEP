...
public class DataInitializer implements CommandLineRunner {
    ...
    private void createRolesIfNotExist() {
        ...
        if (!vaiTroRepository.findByTenVaiTro("ADMIN").isPresent()) {
            ...
            adminRole.setQuyenHan("ALL");
            adminRole.setHoatDong(true);
        ...
        if (!vaiTroRepository.findByTenVaiTro("USER").isPresent()) {
            ...
            userRole.setQuyenHan("READ_PRODUCTS,READ_CATEGORIES,CREATE_ORDER,MANAGE_PROFILE");
            userRole.setHoatDong(true);
            userRole.setNgayTao(LocalDateTime.now());
        ...
        if (!vaiTroRepository.findByTenVaiTro("STAFF").isPresent()) {
            ...
            staffRole.setQuyenHan("READ_PRODUCTS,READ_CATEGORIES,CREATE_ORDER,MANAGE_PROFILE,MANAGE_ORDERS,MANAGE_INVENTORY");
            staffRole.setHoatDong(true);
            staffRole.setNgayTao(LocalDateTime.now());
