...
public class OtpService {
    ...
    private boolean verifyOtp(String inputOtp, String storedHash, String storedSalt) {
        String inputHash = hashOtp(inputOtp, storedSalt);
    ...
    public boolean sendRegistrationOtp(String email) {
        try {
            ...
            String otpHash = hashOtp(otpCode, salt);
            ...
            // Create new OTP
            OtpVerification otp = new OtpVerification(email, otpHash, salt, "REGISTRATION");
    ...
    public boolean verifyRegistrationOtp(String email, String otpCode) {
        try {
            ...
            if (!verifyOtp(otpCode, otp.getOtpHash(), otp.getOtpSalt())) {
