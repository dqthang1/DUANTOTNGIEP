...
class CartManager {
    ...
    renderCart(cartItems, total, itemCount) {
        console.log('Rendering cart with:', cartItems, total, itemCount);
    ...
    renderCartItem(item) {
        ...
        console.log('Item giaBan (old field):', item.giaBan, 'type:', typeof item.giaBan);
            ...
            <div class="cart-item">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4">
                        ...
                        ${item.kichThuoc ? `<p class="text-muted mb-1">Kích cỡ: ${item.kichThuoc}</p>` : ''}
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('CartManager initializing on page:', window.location.pathname);
    
    // Wait a bit to ensure all elements are rendered
    setTimeout(() => {
        console.log('Cart elements available:', {
        ...
        if (document.getElementById('cart-content')) {
            ...
            console.log('Not on cart page, skipping CartManager initialization');
        }
    }, 100);
});
