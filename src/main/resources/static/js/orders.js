                                    ...
                                    <div class="order-item">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                ${item.kichThuoc ? `<small class="text-muted">Kích cỡ: ${item.kichThuoc}</small><br>` : ''}
                                                ${item.mauSac ? `<small class="text-muted">Màu sắc: ${item.mauSac}</small><br>` : ''}
                                                <small class="text-muted">Số lượng: ${item.soLuong}</small>
                                            </div>
                                            <div class="text-end">
                                                <div class="fw-bold">${this.formatCurrency(item.thanhTien || (item.giaBan * item.soLuong))}</div>
                                            </div>
                                        </div>
                                    </div>
                                `).join('')}
                    ...
                    <tbody>
                        ${order.orderItems.map(item => `
                            <tr>
                                ...
                                <td>${item.mauSac || '-'}</td>
                                <td>${item.soLuong}</td>
                                <td>${this.formatCurrency(item.giaBan)}</td>
                                <td>${this.formatCurrency(item.thanhTien || (item.giaBan * item.soLuong))}</td>
                            </tr>
                        `).join('')}
                    </tbody>
                </table>
